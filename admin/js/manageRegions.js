$(document).ready(function () {
    ...
    function openModal(title, value = "", fee = 0, showFee = true) {
        modalTitle.text(title);
        modalInput.val(value);
        if (showFee) {
            modalShippingFee.show().val(fee);
        } else {
    ...
    $("#addProvinceBtn").on("click", function () {
        ...
        openModal("Add Province", "", 0, true); // show shipping fee
    });
    ...
    $(document).on("click", ".editProvinceBtn", function (e) {
        ...
        openModal("Edit Province", $(this).data("name"), $(this).data("fee"), true);
    });
    ...
    $(document).on("click", ".addCityBtn", function (e) {
        ...
        openModal("Add City", "", 0, false); // hide shipping fee
    });
    ...
    $(document).on("click", ".editCityBtn", function () {
        ...
        currentId = $(this).data("id");
        currentProvinceID = $(this).data("provinceid");
        openModal("Edit City", $(this).data("name"), 0, false); // hide shipping fee
    });
    ...
    modalSaveBtn.on("click", function () {
        ...
        switch (currentAction) {
            case "addProvince":
                $.post("ajaxadmin/saveProvince.php", { provinceName: name, shippingFee: fee }, function () {
                    loadProvinces();
                    modal.hide();
            ...
            case "editProvince":
                $.post("ajaxadmin/updateProvince.php", { provinceID: currentId, provinceName: name, shippingFee: fee }, function (res) {
