...
<?php
    ...
    $sql=$con->prepare('SELECT facebooklink,instalink,tiktoklink FROM tblsocialmedia WHERE mediaId = 1 ');
    $sql->execute();
    $linkinfo=$sql->fetch();
?>
<footer>
    ...
    <div class="folowus">
        <h4>Follow Us</h4>
        <div class="logos">
            <a href="<?php echo $linkinfo['facebooklink'] ?>" target="_blank">
            ...
            <a href="<?php echo $linkinfo['instalink'] ?>" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" viewBox="0 0 24 24">
            ...
            <a href="<?php echo $linkinfo['tiktoklink'] ?>" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="white" viewBox="0 0 24 24">
